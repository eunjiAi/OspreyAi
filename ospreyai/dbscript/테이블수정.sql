...
values (7, '다이어트를 위한 최적의 식단은 무엇인가요?', 
        ...
        'Q', 0, to_date('2024-06-01'), 7, 'admin');
...
values (8, '유산소 운동과 근력 운동을 병행해야 하나요?', 
        ...
        'Q', 0, to_date('2024-06-01'), 8, 'admin');
...
'A', 0, to_date('2024-03-12'), 1, 'admin');
...
'A', 0, to_date('2024-05-15'), 3, 'admin');
...
'A', 0, to_date('2024-05-15'), 5, 'admin');
...
values (10, '다이어트를 위한 최적의 식단은 무엇인가요?', 
        ...
        'A', 0, to_date('2024-06-01'), 7, 'admin');
...
values (18, '자세 교정 운동', 
        ...
        'A', 0, to_date('2024-06-15', 'YYYY-MM-DD'), 13, 'admin');
...
values (19, '어깨 통증 완화를 위한 운동', 
        ...
        'A', 0, to_date('2024-06-20', 'YYYY-MM-DD'), 14, 'admin');
...
values (20, '하체 근육을 키우는 운동', 
        ...
        'A', 0, to_date('2024-06-22', 'YYYY-MM-DD'), 15, 'admin');
...
values (21, '허리 통증 예방을 위한 운동', 
        ...
        'A', 0, to_date('2024-06-25', 'YYYY-MM-DD'), 16, 'admin');
...
values (22, '상체 근육을 키우는 운동', 
        ...
        'A', 0, to_date('2024-06-28', 'YYYY-MM-DD'), 17, 'admin');
...
values (26, '무릎 통증을 완화하는 운동', 
        ...
        'A', 0, to_date('2024-07-01', 'YYYY-MM-DD'), 23, 'admin');
...
values (27, '피트니스 목표 설정 방법', 
        ...
        'A', 0, to_date('2024-07-05', 'YYYY-MM-DD'), 24, 'admin');
...
values (28, '체중 감량을 위한 운동 루틴', 
        ...
        'A', 0, to_date('2024-07-08', 'YYYY-MM-DD'), 25, 'admin');
